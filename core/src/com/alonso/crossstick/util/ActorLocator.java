 ...
 * 		- Remover� todos sus listener (clear), impidiendo que tengan efecto acciones de juego. <br>
 * 		- Agregar� un DragListener para desplazarlo libremente por el escenario. <br>
 * 		- Mostrar� estadisticas adicionales. <br>
 * <h2> 3) Usar keyevents que afectar�n las caracteristicas del actor seleccionado: </h2>
 ...
 * @param keyCode El valor de la tecla que fu� presionado
 * @author canyouescape
 */	
public class ActorLocator extends Group {
	 ...
	 * que sea facilmente desplazable. Cada nuevo <b>TouchDown</b> seleccionar� un diferente actor localizable. */
	...
	/** Eval�a la tecla presionada, la cual modificar� los par�metros del actor localizable actual seg�n el
	 * c�digo de tecla. 
	 * @param keyCode El c�digo de teclado presionado.*/
	...
	/** Actualiza las etiquetas que muestran las estad�stica del actor localizable */
