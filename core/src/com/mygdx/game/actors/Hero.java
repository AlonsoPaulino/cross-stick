...
public class Hero extends GenericActor{
	...
	public void act(float delta) {
		 ...
		 if(orientation_y == 1)texture_region = current_animation.getKeyFrame(state_time);
		 else{
			 TextureRegion texture_aux = new TextureRegion(current_animation.getKeyFrame(state_time));
