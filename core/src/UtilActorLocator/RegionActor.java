...
/** La clase RegionActor constituye la clase más genérica de cualquier tipo de actor en escena utilizado en nuestro game.
 * <p>
 * Consta simplemente de un actor con una {@link TextureRegion region} con la cual es dibujada; y posée los más versátiles
 * tipos de constructores a partir de Texture y TextureRegion, permitiendo incluso que el actor tenga una región nula, 
 * es decir, que esté en escena pero no muestre un cuerpo visible.
 * <p>
 * La mayoría de subtipos de actores que se usarán en el game extenderán de esta genérica clase. 
 * <p>
 * Para utilidades de rotación, el centro de origen vendrá ajustado por defecto en el centro del actor
 * @author canyouescape
 * */
public class RegionActor extends Actor {
	...
	private static final float NATURAL_SCALE_WIDTH = 1f;			// Por defecto estos valores deberán ser 1f.
